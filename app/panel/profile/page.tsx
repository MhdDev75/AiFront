          ...
          <div
            ...
            <div className="grid grid-cols-2  gap-1 p-3">
              {themeList.map((item, index) => (
                <div key={index} onClick={() => changeTheme(item)} className="flex flex-col justify-center items-center gap-2">
                  <div className="border-base-content/20 hover:border-base-content/40 overflow-hidden rounded-lg border outline outline-2 outline-offset-2 outline-transparent"
                    ...
                    data-set-theme={item}>
                    <div className="bg-base-100 text-base-content w-full cursor-pointer f" data-theme={item}>
                      <div className="grid grid-cols-5 grid-rows-3">
                        <div className="bg-base-200 col-start-1 row-span-2 row-start-1"></div>
                        <div className="bg-base-300 col-start-1 row-start-3"></div>
                        <div className="bg-base-100 col-span-4 col-start-2 row-span-3 row-start-1 flex flex-col gap-1 p-2">
                          <div className="font-bold">{t(`Profile.${item}`)}</div>
                          <div className="flex flex-wrap gap-1">
                            ...
                            </div> <div className="bg-accent flex aspect-square w-5 items-center justify-center rounded lg:w-6">
                  ...
                  <input type="radio" name={`radio-${index}`} className="radio radio-primary" checked={theme == item}
