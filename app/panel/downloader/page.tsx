      ...
      <div className="grid grid-cols-2 gap-3">
        {Downloader.map((item) => (
          <button
            ...
            className="btn btn-lg h-auto bg-base-200 flex flex-col rounded-3xl gap-8 p-3"
            key={item.id}
          >
            <Image src={item.imageUrl} alt={item.title} width={80} height={80} className="rounded-3xl bg-base-300 h-20 p-3 object-contain" />
